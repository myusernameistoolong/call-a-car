            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="bday" class="col-md-4 col-form-label text-md-right">{{ __('Geboortedatum') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="privacy_permission" class="col-md-4 col-form-label text-md-right">{{ __('Privacy vrijgeven') }}</label>

                            <div class="col-md-6">
                                <input id="privacy_permission" type="checkbox" class="form-control @error('privacy_permission') is-invalid @enderror" name="privacy_permission">

                                @error('privacy_permission')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" maxlength="12" required autocomplete="phone">
