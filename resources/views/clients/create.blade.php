        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h2 class="my-4"><i class="fas fa-users"></i> Creëer een nieuwe klant</h2>
                    <form action="/clients" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Voeg klant toe</button>
                        <button type="button" onclick="location.href='/clients'" class="btn btn-secondary"><i class="fas fa-ban"></i> Annuleren</button>
                    </form>
                </div>
            </div>
        </div>
